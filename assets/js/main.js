...
function toggleSkills(){
    let itemClass = this.parentNote.className

    for(i = 0; i< skillsContent.lengh; i++){
        skillsContent[i].classname = 'skills__content skills__close'
    }
    if(itemClass === 'skills__content skills__close'){
        this.parentNote.className = 'skills__content skills__open'
...
/*==================== SERVICES MODAL ====================*/
    const modalViews = document.querySelectorAll('.services__modal'),
        ...
        modalCloses = documnet.querySelectorAll('.services__modal-close') 
